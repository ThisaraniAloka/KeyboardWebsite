  ...
  return (
    ...
    >
      <FadeIn className="relative mx-auto max-w-7xl px-4 text-center" targetChildren>
        ...
        <button className={clsx("group relative w-full overflow-hidden rounded-full border-8 border-gray-900 bg-linear-to-r/oklch from-sky-300 to-sky-600 px-6 py-6 ease-out focus:ring-[24px] focus:ring-sky-500/50 focus:outline-none motion-safe:transition-all motion-safe:duration-300 md:border-[12px] md:px-20 md:py-16")}>{slice.primary.button_text}</button>
